...
//   fetch("http://mshastri.pythonanywhere.com/getacdatas")
//   .then(response => {
...
// }, [])
  ...
  return (
    <div>
      <Typography variant='h4' p={2} color="#3f51b5">Account Data</Typography>
      ...
      <Table  aria-label="simple table"  >
        ...
        <TableBody sx={{border:1}}>
          {rows.map((row) => (
            <TableRow sx={{border:1}}>
              <TableCell component="th" scope="row"  sx={style3} align="center"> 12</TableCell>
